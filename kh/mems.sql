...
CREATE TABLE tb_payment (
   ...
   payment_message   varchar2(200)      NOT NULL,
   payment_date   date   DEFAULT sysdate   NOT NULL,
   payment_result   char(1)   DEFAULT 'N'   NOT NULL
);
...
COMMENT ON COLUMN tb_payment.payment_message IS '결제내역';

COMMENT ON COLUMN tb_payment.payment_date IS '결제일자';

COMMENT ON COLUMN tb_payment.payment_result IS '결제처리결과';
...
CREATE TABLE tb_withdrawal (
   ...
   academy_target_grade   varchar2(10)      NULL,
...
CREATE TABLE  tb_academy_source  (
    ...
    academy_road_address    varchar2(200)      NULL,
    academy_road_address_detail    varchar2(200)      NULL,
    ...
    academy_loading_date_time    date   DEFAULT sysdate   NULL
);
...
COMMENT ON COLUMN  tb_academy_source . academy_road_address_detail  IS '도로명상세주소';
...
values ('abc123', 1, '김시온', '1234', 'kimzion9812@gmail.com', TO_DATE('1998-12-17'), '경기도 시흥시', '01011112222', TO_DATE('2022-11-11'), 0, sysdate, sysdate); 

insert into tb_personal 
values ('kkk123', 1, '강민호', '1234', 'minho00@gmail.com', TO_DATE('2000-01-01'), '서울시 노원구', '01033334444', TO_DATE('2022-10-10'), 0, '', sysdate); 

insert into tb_personal 
values ('yoon123', 1, '윤덕중', '1234', 'yoon12@gmail.com', TO_DATE('2000-03-03'), '서울시 송파구', '01055556666', TO_DATE('2022-04-10'), 0, '', sysdate); 

----학원회원 데이터 입력
insert into tb_academy
values ('aca11', 2, '0123456789', sysdate, '1234', '창조의아침', '마포구', '서교동', '마포구 와우산로 41', '0212341234', '김민재', 'mj123@naver.com', '01012341234', '중등', '미술', '친절', '', '', '', '', '40만원 이상 50만원 미만', sysdate, 0, '');

insert into tb_academy
values ('aca22', 2, '234567890', sysdate, '1234', '영재수학학원', '서대문구', '연희동', '서대문구 연희로 11', '0223452345', '임영웅', 'hero123@naver.com', '01023452345', '고등', '수학', '상위권', '', '', '', '', '30만원 이상 40만원 미만', sysdate, 0, '');


---- 관리자 회원 데이터 입력
insert into tb_admin
values('admin11', 3, 'pwd1', 'team1', '김나연', 'kny123@naver.com', '01012341234', sysdate, sysdate);
select * from tb_admin;
insert into tb_admin
values('admin22', 3, 'pwd2', 'team2', '최영민', 'cym123@naver.com', '01043214321', sysdate, sysdate);

---- 매칭게시판 데이터 입력
insert into tb_matching_board
values (1, 'abc123', 'N', '', sysdate, sysdate);

insert into tb_matching_board
values(2, 'kkk123', 'Y', '1234', sysdate, sysdate);

insert into tb_matching_board
values(3, 'yoon123', 'N', '', sysdate, sysdate);

---- 매칭게시판 댓글 데이터 입력 (게시글번호-댓글번호-회원id)
insert into tb_matching_comment
values (1, 'aca11',1,  '창조의아침', '안녕하세요', sysdate);

insert into tb_matching_comment
values (1, 'aca22',2,  '영재수학학원', '반가워요', sysdate);

insert into tb_matching_comment
values (2, 'aca22', 2, '영재수학학원', '감사해요', sysdate);


---- 공통게시판 데이터 입력
insert into tb_common_board 
values (10001, 'abc123', '', '', 1, '', '자유 제목1', '자유 본문1', sysdate, '', 0, 'N', '');

insert into tb_common_board 
values (20001, '', 'aca11', '', 2, '', '홍보 제목1', '홍보 본문1', sysdate, '', 0, 'N', '');

insert into tb_common_board 
values (30001, '', '', 'admin11', 3, '', '공지 제목1', '공지 본문1', sysdate, '', 0, 'N', '');



---- 공통게시판 댓글 데이터 입력(게시글번호-댓글번호-id)
insert into tb_common_comment
values (10001, 1, 'kkk123', '댓글1', sysdate);

insert into tb_common_comment 
values (10001, 2, 'yoon123', '댓글2', sysdate);
...
insert into tb_like
values (10001, 'yoon123');

---- 첨부파일 데이터 입력
insert into tb_file
values (20001, 1, 'file.image1', '커리큘럼1');

insert into tb_file
values (20001, 2, 'file.image2', '커리큘럼2');

insert into tb_payment
values ('0001', 'aca11', '결제1회', sysdate, 'Y');
